	...
	<div class="admin_grp">
		...
		<div class="admin_ct">
			<form:form commandName="noticeModel" name="formWrite"
				action="noticeUpdate.see" method="post"
				enctype="multipart/form-data">
				<input type="hidden" name="notice_no"
					value="${noticeModel.notice_no}" />
				<input type="hidden" name="notice_content_file"
					value="${noticeModel.notice_content_file}" />
				<div class="tabCont">
					<div>
						<fieldset>
								...
								<tbody>
									...
									<tr>
										...
										<td><form:input name="notice_subject" type="text"
												...
												id="subject" class="ipt_txt03" path="notice_subject" /> <font
									...
									<tr>
										...
										<td><form:input name="notice_area" type="text"
												maxlength="40" value="${noticeModel.notice_area}"
												id="notice_area" class="ipt_txt" path="notice_area" /> <span
											class="area" id="spanCinemaName"> </span> <a
											href="javascript:selected();" title="레이어 열림"
											class="btnv_pick">영화관선택</a> <font color="red"><form:errors
