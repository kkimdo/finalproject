...
<body>
	...
	<div class="cs_center">
		...
		<form name="formUpdate" action="noticeUpdate.see" method="post" enctype="multipart/form-data">
							...
							<tbody>
								...
								<tr>
									...
									<td><input name="notice_subject" type="text"
										...
										id="subject" class="ipt_txt03" /> <font color="red"><form:errors
								...
								<tr>
									...
									<td><textarea name="notice_content" rows="10" cols="30"
											id="content" class="textarea01">${noticeModel.notice_content}</textarea>
