		...
		<div id="content">
			<div class="privacy_wrap">
				...
				<div class="privacy_con">
					...
					<p class="default_txt">이 약관은 롯데쇼핑㈜시네마사업본부(이하 '무미비씨'라 합니다)가 운영하는
						영화관 및 홈페이지(www.lottecinema.co.kr, m.locine.co.kr)/어플리케이션과 롯데멤버스
					...
					<p class="default_nomargin">1. '무미비씨'란 롯데쇼핑㈜시네마사업본부가 재화 또는 용역을
					...
					<p class="default_nomargin">4. '롯데멤버스 회원사'(이하 '회원사'라 한다)란
						L.POINT 사이트를 운영하고 있는 롯데그룹의 계열사를 의미합니다.</p>
					...
					<p class="default_nomargin">3.롯데 포인트플러스 카드의 경우 영화 관람을 위해 회원이
						결제한 티켓 금액의 2.5%가 적립되며, 롯데카드에서 추가로 2.5% 더블 적립되어 총 5%가 적립됩니다.</p>
					...
					<p class="default_nomargin">6.1일 최대 적립 가능한 포인트는 제한이 없습니다. 다만,
						...
						L.POINT가 적립되지 않습니다. 또한, 샤롯데 라운지에서 물품을 구입한 경우 L.POINT가 적립 되지 않습니다.</p>
					<p class="default_txt">
