...
<dd class="tab_login_con active">
                                    ...
                                    <div class="clear_fix">
                                        <div class="login_left">
                                            ...
                                            <!-- //0304 문구수정 -->
                                            <div class="login_box">
                                            <form:form commandName="member" action="/movie/member/memberFindPw.see" method="POST" name="joinform">
                                                <div style="margin-top: 10px">
                                                  ...
                                                  <div style="margin-top: 10px">
                                                   ...
                                                   <form:input type="text" class="text" path="member_email" placeholder="가입하신 이메일을 입력하세요." />
                                                      ...
                                                      <div style="margin-top: 10px">
                                                	<label>ID</label>
                                                   <form:input type="text" class="text" path="member_id" placeholder="가입하신 ID를 입력하세요." />
                                                       <form:errors path="member_password1" />
                                                    </div>
