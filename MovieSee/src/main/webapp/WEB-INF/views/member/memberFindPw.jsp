...
<h1>비밀번호 찾기</h1>
<form:form commandName="member" action="/movie/member/memberFindPw.see" method="POST"
	name="joinform">
	...
	<table>
		<tbody>
			...
			<tr>
				<th scope="row">ID</th>
				<td><form:input type="text" class="txt w200"
						path="member_id" required="true" placeholder="가입하신  ID를 적어주세요."
						 />
				<form:errors
							path="member_password1" /></td>
			</tr>
			...
			<tr>
				<th scope="row">찾으신 비밀번호</th>
				<td><form:input type="text" class="txt w200" readonly="true"
						path="member_password1" 
						 value="${member.member_password1}" />
