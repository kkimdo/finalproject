...
<script type="text/javascript">
	function deleteCheck(){
		var check = document.getElementById("freeBoardDel");
		check.method = "post";
		check.action = "<%=cp %>/free/freeBoardDelete.see";
		check.submit();
	}
</script>
					...
					<div class="row">
						...
						<div class="col-md">
							<div class="form-wrap __normal __x1">
								...
								<input type="button" onclick="deleteCheck()" class="ui-button __square-small __black" value="확인">
							</div>
						</div>
					</div>
				</div>
