...
<body>
	<div class="gnb">
		...
		<ul>
			...
			<li class="active"><a href="<%=cp%>/aMovieList.see" title="영화">영화</a>
				<div class="depth">
					...
					<ul>
						...
						<li class="active"><a href="<%=cp%>/bMovieList.see"
							title="아르떼">아르떼</a></li>
			...
			<li><a href="<%=cp%>/event/eventListMain.see" title="이벤트">이벤트</a></li>
				...
				<div class="control_navi">
					...
					<div class="ctr_btn">
						<a href="javascript:void(0);" class="rolling_play"
							...
							src="/LCHS/Image/Btn/btn_m_play.png" alt="자동롤링 재생"></a> <a
							href="javascript:void(0);" class="rolling_stop"
							style="display: none;"><img
							src="/LCHS/Image/Btn/btn_m_stop.png" alt="자동롤링 멈춤"></a>
					</div>
				</div>
				<ul class="bannerImg" id="ulMovieKeyValue">
					<li class="active"
						style="background: url(&quot;undefined&quot;) 50% 0px no-repeat; left: 0px;"><img
						src="<%= cp %>/resources/upload/movie/movie_intro/${movieintroselect.movie_intro_arte_top}"
						alt=""> <span class="blind">undefined</span></li>
				</ul>
			</div>
		</div>
		...
		<div class="screen_cwrap">
			...
			<div class="tab_content on">
				...
				<ul class="curr_list movie_clist" id="arteMovieList">
					...
					<c:forEach var="moviearteList" items="${moviearteList}"
						varStatus="stat">
						...
						<li>
							<div class="curr_box">
								<span class="img"> <a href=''> <img
										src="<%= cp %>/resources/upload/movie/main_movie/${moviearteList.movie_poster}"></a>
								</span>
		...
		<td colspan="13" class="tac">등록된 스케쥴이 없습니다.</td>
							...
							<dl class="list_text">
								<dt>
									...
									</span>&nbsp;&nbsp;${moviearteList.movie_name}
									</a>
								</dt>
								<dd>
									<span class="rate">예매율 ${moviearteList.movie_rate} %</span> <span
										class="list_score">&nbsp;|&nbsp;&nbsp;관람평점
										${moviearteList.movie_score} 점</span>
								</dd>
							</dl>
						</li>
					</c:forEach>
