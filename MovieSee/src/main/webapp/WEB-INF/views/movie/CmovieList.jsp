			...
			<li class="active"><a href="<%=cp%>/aMovieList.see" title="영화">영화</a>
				<div class="depth">
					...
					<ul>
						...
						<li class="active"><a href="<%=cp%>/cMovieList.see"
							title="G시네마">G시네마</a></li>
		...
		<div class="screen_cwrap">
			...
			<div class="tab_content on">
				...
				<ul class="curr_list movie_clist" id="moviegcinemaList">
					...
					<c:forEach var="moviegcinemaList" items="${moviegcinemaList}"
						varStatus="stat">

						<c:set value="${moviegcinemaList.movie_age}" var="movie_age" />
						...
						<li>
							<div class="curr_box">
								<span class="img"> <a href=''> <img
										src="<%= cp %>/resources/upload/movie/main_movie/${moviegcinemaList.movie_poster}"></a>
								</span>
							</div> <!-- hover시 이미지 -->
							...
							<dl class="list_text">
								<dt>
									...
									</span>&nbsp;&nbsp;${moviegcinemaList.movie_name}
									</a>
								</dt>
								<dd>
									<span class="rate">예매율 ${moviegcinemaList.movie_rate} %</span>
									<span class="list_score">&nbsp;|&nbsp;&nbsp;관람평점
										${moviegcinemaList.movie_score} 점</span>
								</dd>
							</dl>
						</li>
					</c:forEach>
					<c:if test="${fn:length(moviegcinemaList) le 0}">
