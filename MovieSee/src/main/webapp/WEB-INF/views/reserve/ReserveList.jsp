...
<div class="myCinema">
                ...
                <div class="myInfo">
                    ...
                    <div class="myInfoTit">
                        <em><span class="userName" id="spnUserName">${session_member_name}</span>님 환영합니다!</em>
                        <dl>
...
<!--                         <ul class="tabDep2">
                    ...
                    <li class=""><a
					href="<%=cp%>/gift/purchaseMemberList.see">기프트샵 구매 내역</a>
					</li>
                    
                    <li class="pointRat" style="">
                        <a href="<%=cp%>/gift/purchaseMemberCancleList.see">기프트샵 취소 내역</a><!--170915 cok 문구 교체 멤버십 ->VIP 기준 -->
                        <ul class="tabDep2">
                    ...
                    <li class="myContact" style="">
                        <a href="<%=cp%>/qna/qnaMemberList.see">나의 문의 내역</a>
