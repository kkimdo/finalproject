...
public class HandlerFile {
	...
	private String oldName; // download
	private HttpServletResponse response; // download
	private byte[] fileByte; // download
	...
	public HandlerFile(MultipartHttpServletRequest multipartRequest) {
		this.multipartRequest = multipartRequest;
		//this.filePath = multipartRequest.getSession().getServletContext().getRealPath("/uploads/event");
		this.filePath = "C:/github/finalproject/MovieSee/src/main/webapp/uploads/event/";
		fileNames = new HashMap<String, List<String>>();
	}
