...
public class ReserveTimeTableModel {
	int timetable_no;
	...
	public int getTimetable_adult_cnt() {
		return timetable_adult_cnt;
	}
	public void setTimetable_adult_cnt(int timetable_adult_cnt) {
		this.timetable_adult_cnt = timetable_adult_cnt;
	}
	public int getTimetable_child_cnt() {
		return timetable_child_cnt;
	}
	public void setTimetable_child_cnt(int timetable_child_cnt) {
		this.timetable_child_cnt = timetable_child_cnt;
	}
}
