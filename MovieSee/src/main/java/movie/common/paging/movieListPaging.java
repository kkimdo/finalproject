...
public class movieListPaging {
	...
	// 페이징 생성자
	public movieListPaging(int currentPage, int totalCount, int blockCount, int blockPage, String viewName) {
	...
	// Search있는 생성자
	public movieListPaging(int currentPage, int totalCount, int blockCount, int blockPage,String viewName, int searchNum, String isSearch){
